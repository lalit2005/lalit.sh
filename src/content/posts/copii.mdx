---
title: "Copii: Ready to use copy button for README files"
...
{/* <Image s={'/static/blog/copii/contributions-1.png'} a={''} d={'750x180'} /> */}

**to this 👇**

{/* <Image s={'/static/blog/copii/contributions-2.png'} a={''} d={'750x180'} /> */}
...
- Scroll down to the form
  {/* <Image s={'/static/blog/copii/form.png'} a={''} d={'720x400'} /> */}
- Check the check box if you want Dark Mode in redirecting page ( optional )
  {/* <Image s={'/static/blog/copii/dark-mode.png'} a={''} d={'1113x461'} /> */}
- Enter the text/code you want to be copied when the user clicks on `Copy` button in README file
  {/* <Image s={'/static/blog/copii/textarea.png'} a={''} d={'720x400'} /> */}
- Enter the URL ( optional ) for custom logo in redirecting page
  {/* <Image s={'/static/blog/copii/custom-logo.png'} a={''} d={'720x400'} /> */}
- Click on `Generate`
  {/* <Image s={'/static/blog/copii/generate.png'} a={''} d={'720x400'} /> */}
- Now you will be able to see 3 buttons that you can use
  {/* <Image s={'/static/blog/copii/result.png'} a={''} d={'720x800'} /> */}
