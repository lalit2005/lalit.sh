...
<Gallery
  images={[
    "/static/blog/hyperdocs/og.png||Hyperdocs",
    "/static/project/hyperdocs/docs-page.png||Docs page",
    "/static/blog/hyperdocs/cli.png||CLI",
    "/static/blog/hyperdocs/feedback.png||Feedback widget",
    "/static/blog/hyperdocs/comparison.png||Comparison against other tools",
  ]}
/>
...
Read [this](/blog/hyperdocs) to learn more about how Hyperdocs works under the hood and how I built it for the hackathon.

This is how generated docs site looks like.

![Docs](/static/project/hyperdocs/docs-page.png)
