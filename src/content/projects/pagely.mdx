---
title: Pagely
description: Build blazing fast websites from Notion. In light speed.
...
<Gallery
  images={[
    "/static/project/pagely/og.png|||Pagely",
    "/static/blog/pagely/integrations.png|||Integrations",
  ]}
/>
...
- Much better than a regular public Notion page:
  ...
  - Oof.. There are loads of other [features](https://lalit.vercel.app/posts/pagely#features-).

## Blog

Read [this](/posts/pagely) to learn more about how Pagely works under the hood and how I built it for the hackathon.
